...
var _a;
import require$$0$5, { app, ipcMain, desktopCapturer, BrowserWindow } from "electron";
...
function createWindow() {
  ...
  if (VITE_DEV_SERVER_URL) {
    ...
    floatingWebcamWin.loadURL(`${"http://localhost:5173"}/webcam.html`);
  } else {
    win.loadFile(path$6.join(RENDERER_DIST, "index.html"));
    studioWin.loadFile(path$6.join(RENDERER_DIST, "studio.html"));
    floatingWebcamWin.loadFile(path$6.join(RENDERER_DIST, "webcam.html"));
  }
}
