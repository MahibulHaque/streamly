...
import { SystemMode } from '@/components/icons/system-mode';
	...
	return (
		<div>
			...
			<p className="text-muted-foreground">
				Enabling this feature will send you notifications when someone
				watched your video for the first time. This feature can help during
				client outreach.
			</p>
